...
public class DspLocationHelper {
  ...
  public Optional<Location> toLocation(Source source, int lineNumber, String frameName) {
    ...
    if (frameName == null) {
      ...
      return Optional.of(
          new LocationImpl(workspacePath, lineNumber, false, 0, resourceProjectPath, method, 0));
    }
  }

  public Optional<Location> toLocation(Source source, int lineNumber) {
    return toLocation(source, lineNumber, null);
  }
